...
The complete code for this tutorial is available on [GitHub](https://github.com/shrutikapoor08/building-tanstack-apps-movies).
...
Now let's create our route that fetches data from the TMDB API. Create a new file at `src/app/fetch-movies.tsx`:

```typescript
// src/app/fetch-movies.tsx
